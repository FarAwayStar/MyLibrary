...
namespace MyLibrary
{
    class DBAccess
    {
        ...
        public static string strSQLConnection = "Data Source=DESKTOP-IKTFLER;Database=Library;User id=yld;PWD=yld971202cc";

        public static int nLoginType = 0;            //用户登录与重新登录的标识
        public static string strSQLSelectAll = "Select * from dbo.User"; //存储职工基本信息表中的SQL语句
